...
class question(models.Model):
    ...
    asked_by=models.CharField(max_length=5000)
    #0 is not answered
...
class answer(models.Model):
    ...
    answered_on=models.DateField(auto_now=True, auto_now_add=False,blank=True)
    upvotes=models.IntegerField(blank=True)
    downvotes=models.IntegerField(blank=True)
    def __str__(self):
        t=str(self.id)
